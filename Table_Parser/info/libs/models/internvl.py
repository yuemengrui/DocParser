...
from info.libs.models.internvl_conversation import get_conv_template


class InternVL(nn.Module):
    def __init__(self, model_path='', max_new_tokens=1024, max_time=30, flash_attn=False, dtype=torch.bfloat16,
                 **kwargs):
        super().__init__()
    ...
    def forward(self, images, output_format: str = 'latex', max_new_tokens: int = 1024, **kwargs):
        ...
        for bs_idx in range(batch_size):
            pixel_values = pixel_values_list[bs_idx].to(self.dtype)
